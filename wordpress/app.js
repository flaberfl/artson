(() => {
  ...
  function menuInit() {
    if (document.querySelector(".wrap-icon-btn")) document.addEventListener("click", (function (e) {
  ...
  function menuInitDesk() {
    if (document.querySelector(".wrap-icon-btn-d")) document.addEventListener("click", (function (e) {
      if (e.target.closest(".wrap-icon-btn-d")) document.documentElement.classList.toggle("menu-open");
    }));
  }
  ...
  function initSliders() {
    if (document.querySelector(".types__slider")) new swiper_core_Swiper(".types__slider", {
      modules: [Pagination],
      observer: true,
      observeParents: true,
      spaceBetween: 20,
    ...
    if (document.querySelector(".docs__slider")) new swiper_core_Swiper(".docs__slider", {
  ...
  let myTextSlider = new swiper_core_Swiper(".portfolio__slider_text", {
    modules: [Navigation],
    observer: true,
    observeParents: true,
    slidesPerView: 1,
  ...
  let myImageSlider = new swiper_core_Swiper(".portfolio__slider", {
    modules: [Navigation],
    observer: true,
    observeParents: true,
    slidesPerView: 1,
  ...
  let myTextSlider_2 = new swiper_core_Swiper(".portfolio__slider_text_2", {
    modules: [Navigation],
    observer: true,
    observeParents: true,
    spaceBetween: 20,
  ...
  let myImageSlider_2 = new swiper_core_Swiper(".portfolio__slider_2", {
    modules: [Navigation],
    observer: true,
    observeParents: true,
    spaceBetween: 20,
  ...
  new swiper_core_Swiper(".video__slider", {
...
***************************************************************************** */
  ...
  const objPopupVideoLink = document.querySelectorAll(".video__button");
  document.querySelectorAll(".video-popup");
  objPopupVideoLink.forEach(((element, i) => element.setAttribute("data-popup", "#video-popup" + "-" + i)));
  for (var b, i = 0; b = document.getElementById("video-popup"); ++i) b.id += "-" + i;

  const objPopupTypesLinkNew = document.querySelectorAll(".item-types__link_new");
  document.querySelectorAll(".types-works-popup_new");
  objPopupTypesLinkNew.forEach(((element, i) => element.setAttribute("data-popup", "#types-works-popup-new" + "-" + i)));
  for (var b, i = 0; b = document.getElementById("types-works-popup-new"); ++i) b.id += "-" + i;

  const objPopupTypesLinkOld = document.querySelectorAll(".item-types__link_old");
  document.querySelectorAll(".types-works-popup_old");
  objPopupTypesLinkOld.forEach(((element, i) => element.setAttribute("data-popup", "#types-works-popup-old" + "-" + i)));
  for (var b, i = 0; b = document.getElementById("types-works-popup-old"); ++i) b.id += "-" + i;
  ...
  function ValueInp() {
    ...
    if (this.value > 500) this.value = this.value.substr(0, 1);
    if (this.value !== "") startNext.disabled = false; else startNext.disabled = true;
  }
  quizItems.forEach(((quizItem, quizItemIndex) => {
    quizItem.addEventListener("change", (e => {
      ...
      if (inputsChecked.length > 0) btnsNext[quizItemIndex].disabled = false; else {
        btnsNext[quizItemIndex].disabled = true;
        if (field.value !== "") btnsNext[quizItemIndex].disabled = false; else btnsNext[quizItemIndex].disabled = true;
      }
    }));
  }));
  ...
  function SendPresent() {
    ...
    btnPresent.addEventListener("click", (function () {
      for (let radio of radios) if (radio.checked) outputPresent.innerHTML = radio.value;
    }));
  }
